...
type ArticleServiceClient interface {
	Create(ctx context.Context, in *ArticleCreateRequest, opts ...grpc.CallOption) (*ArticleCreateResponse, error)
}
...
func (c *articleServiceClient) Create(ctx context.Context, in *ArticleCreateRequest, opts ...grpc.CallOption) (*ArticleCreateResponse, error) {
...
func (UnimplementedArticleServiceServer) Create(context.Context, *ArticleCreateRequest) (*ArticleCreateResponse, error) {
...
var ArticleService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/article/article_service.proto",
}
